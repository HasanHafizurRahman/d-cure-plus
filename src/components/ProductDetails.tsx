...
export default function ProductDetails() {
  ...
  const tabs = [
    {
      id: 'ingredients',
      label: 'মূল উপাদানসমূহ',
      subtitle: 'Ingredients',
      icon: <FlaskConical className="w-5 h-5" />
    },
    {
      id: 'pharmacology',
      label: 'বৈজ্ঞানিক কার্যপ্রণালী',
      subtitle: 'Pharmacology',
      icon: <Dna className="w-5 h-5" />
    },
    {
      id: 'benefits',
      label: 'দিক নির্দেশনা ও উপকারিতা',
      subtitle: 'Indications',
      icon: <HeartPulse className="w-5 h-5" />
    },
    {
      id: 'dosage',
      label: 'সেবনবিধি ও বিশেষ উপদেশ',
      subtitle: 'Guidelines',
  ...
  return (
    <section id="specifications" className="py-20 bg-gradient-to-b from-[#f7faf8] to-white relative overflow-hidden">
      ...
      <div className="max-w-(--spacing-container-max) mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center bangla-text">
        ...
        <div className="max-w-5xl mx-auto bg-white/70 backdrop-blur-md border border-slate-200 p-2 rounded-2xl shadow-xs mb-10 overflow-x-auto scrollbar-hide flex lg:grid lg:grid-cols-4 gap-2">
          {tabs.map((tab, idx) => {
            ...
            return (
              <button
                ...
                className={`flex items-center justify-center gap-3 py-3.5 px-5 rounded-xl text-sm font-semibold transition-all duration-300 shrink-0 cursor-pointer ${
                  isActive
                    ? 'bg-brand-green text-white shadow-md shadow-brand-green/15'
                    : 'text-primary-dark/75 hover:bg-slate-50 hover:text-primary-dark'
                }`}
              >
                <div className={`p-1.5 rounded-lg transition-colors duration-300 ${
                  isActive ? 'bg-white/20 text-white' : 'bg-slate-100 text-brand-green'
                }`}>
                  {tab.icon}
                </div>
                <div className="text-left font-display">
                  <p className="leading-none text-xs font-bold uppercase font-sans tracking-wider opacity-60">
                    {tab.subtitle}
                  </p>
                  <p className="mt-0.5 leading-tight">{tab.label}</p>
                </div>
              </button>
            );
          })}
              ...
              {activeTab === 1 && (
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    {/* Organic Compound - Gymnemic Acid (Zymnemic Acid) */}
                    <div className="bg-white border border-slate-200 p-6 rounded-2xl flex gap-4 hover:border-brand-green/30 transition-colors duration-200">
                      <div className="w-12 h-12 rounded-xl bg-brand-green/8 flex items-center justify-center border border-brand-green/10 text-brand-green shrink-0">
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-white border border-slate-200 p-6 sm:p-8 rounded-2xl shadow-xs">
                    <h3 className="text-lg sm:text-xl font-display font-bold text-primary-dark mb-4 flex items-center gap-2">
                      <HeartPulse className="text-brand-green" />
