...
export const faqItems: FAQItem[] = [
  {
    id: 'faq-5',
    question: 'আসলে কি এটা ডায়াবেটিসের উপসর্গের চিকিৎসা নাকি এটা ডায়াবেতিসের স্থায়ী চিকিৎসা',
    answer: 'যেহেতু এটি প্যানক্রিয়াটিক ড্যামেজ বিটা সেলকে সেল প্রলিফারেশনের মাধ্যমে সুস্থ হয় ও বিটা সেল রিজেনারেশন হয়, এমন ফুড গ্রেড হার্বসের সমন্বয়ে তৈরি, উপাদানের সমন্বয়ে তৈরি, তাই অবশ্যই এটি ডায়াবেটিসের স্থায়ী চিকিৎসা।'
  },
  {
    id: 'faq-6',
    question: 'এটি সেবনে কি হাইপোগ্লাইসেমিয়া (রক্তে সুগার অতিরিক্ত কমে যাওয়া) হওয়ার কোনো ভয় আছে?',
    answer: 'যেহেতু এটি ফুড গ্রেড অ্যান্টি-ডায়াবেটিক হার্বসের দ্বারা তৈরি, সেহেতু এর কোনো সিভিয়ার হাইপোগ্লাইসেমিক কন্ডিশনে গিয়ে তার আকস্মিক কোনো মৃত্যুর সম্ভাবনা নেই।'
  },
  {
    id: 'faq-1',
